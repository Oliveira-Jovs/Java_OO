...
public class Cenarioo {	public static void main(String[] args) {
	...
	while (continuar) { System.out.println(); System.out.print("Deseja continuar (s/n): "); 
	String sair = inpute.nextLine(); if (sair.equalsIgnoreCase("n")) {continuar = false; // Sai do loop se o comando for "sair"
	} else {
		...
		for (Visitantes adlista : ((Administracao)administracao).getVisitantes()){
			System.out.println("Nome do visitante " + adlista.getNome()+ " e" +" idade do visitante "+adlista.getIdade());
